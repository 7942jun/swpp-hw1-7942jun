var Form = /** @class */ (function () {
    function Form(email, password, password_confirmation, phone_number, fname, lname, age, birth_month, birth_day, birth_year) {
        this.email = email;
        ...
        this.checkbirth_month = function () {
        ...
        this.checkbirth_day = function () {
            return this.birth_day >= 10 && this.birth_day < 100;
        };
        this.checkbirth_year = function () {
...
but.onclick = function () {
    ...
    var alertMessage = "You must Correct:\n\n";
